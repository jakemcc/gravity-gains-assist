...
- [ ] Replace the Health Connect permissions rationale placeholder copy with final user-facing text.
- [ ] Make the permissions rationale explicit that the app reads weight data from Health Connect and syncs it to Grip Gains.
